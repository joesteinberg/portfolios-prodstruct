function varargout = ls_solution_js(varargin);
...
%
% NOTE BY JOSEPH STEINBERG: I MODIFIED THIS CODE TO ALLOW FOR A MATRIX OF IID VARIABLES RATHER THAN A SINGLE ONE
% THIS IS NECESSARY WHEN WE'VE GOT MORE THAN ONE BUDGET CONSTRAINT IN THE MODEL WITH MORE THAN 2 COUNTRIES
%
...
if rank(z11)<ns;
 error('Invertibility condition violated! rank(z11) = %d',rank(z11));
end
...
B1=BX(1:ns,:); % JBS NOTE: MODIFICATION HERE
B2=BX(ns+1:nr,:); % JBS NOTE: MODIFICATION HERE
